...
// class constructor
RecommendationSystem::RecommendationSystem(int** userMovieRatingsMatrix_in, int** userShowRatingsMatrix_in){
	userMovieRatingsMatrix = userMovieRatingsMatrix_in;
	userShowRatingsMatrix = userShowRatingsMatrix_in;
}
